// User data
const users = [
    { name: "Daniel Grech", username: "dan_grec", password: "lejber", coins: "68" },
    { name: "1", username: "1", password: "1", coins: "100" },
    { name: "John Gatt", username: "John_LLTK", password: "rutartsinimmaawqal", coins: "10" },
    { name: "Daniel Vella", username: "danielrix08", password: "Iamgay17", coins: "30" },
    { name: "Matteo Camilleri", username: "Matteo", password: "12bucklemyshoe", coins: "15" },
    { name: "Kenneth Micallef", username: "Kennybat1n1", password: "abbatinikjddm", coins: "20" },
    { name: "Jake Sacco", username: "jake_sax", password: "kondoljanzi", coins: "30" },
    ...
    { name: "Kieran Calleja", username: "kieran_kiskis", password: "kiskis1908", coins: "48" },
    { name: "Denzil Bugeja", username: "denzil", password: "denzil21", coins: "75" },
    ...
    { name: "Matthias Bonnici", username: "matthiasbonnici", password: "alabibilbajd", coins: "0"}
];
